...
<template>
  <div class="login-left-view">
    <div class="logo">
      ...
      <ArtLogo v-else class="icon" size="46" />
      <h1 class="title">{{ site.title || AppConfig.systemInfo.name }}</h1>
    </div>
    ...
    <div class="text-wrap">
      <h1>{{ site.description || $t('login.leftView.title') }}</h1>
      <p v-if="site.subDescription">{{ site.subDescription }}</p>
    </div>
