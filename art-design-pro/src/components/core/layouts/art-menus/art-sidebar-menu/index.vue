...
<template>
  ...
  >
    ...
    >
      <img v-if="site.logo" :src="site.logo" class="logo-img" alt="logo" @click="navigateToHome" />
      <ArtLogo v-else class="logo" @click="navigateToHome" />
    ...
    >
      ...
      >
        <img v-if="site.logo" :src="site.logo" class="logo-img" alt="logo" />

        <ArtLogo v-else-if="!isDualMenu" class="logo" />
