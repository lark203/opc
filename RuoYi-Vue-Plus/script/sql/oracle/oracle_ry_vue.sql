...
create table sys_user (
  ...
  password_update_time date default null
);
...
comment on column sys_user.password_update_time is '密码最后更新时间';
...
alter table sys_user_password_history add constraint pk_sys_user_password_history primary key (history_id);

create index idx_sys_user_password_history_user_id on sys_user_password_history (user_id);

comment on table  sys_user_password_history              is '用户密码历史记录表';
comment on column sys_user_password_history.history_id  is '历史ID';
comment on column sys_user_password_history.user_id     is '用户ID';
comment on column sys_user_password_history.password    is '密码哈希（BCrypt）';
comment on column sys_user_password_history.create_time is '创建时间';

-- ----------------------------
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1761100000000000001, 1761000000000000103, 'admin', '疯狂的狮子Li', 'sys_user', 'crazyLionLi@163.com', '15888888888', '1', null, '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate, 1761000000000000103, 1761100000000000001, sysdate, NULL, null, '管理员', sysdate);
insert into sys_user values(1761100000000000003, 1761000000000000108, 'test', '本部门及以下 密码666666', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate, 1761000000000000103, 1761100000000000001, sysdate, NULL, null, sysdate, '');
insert into sys_user values(1761100000000000004, 1761000000000000102, 'test1', '仅本人 密码666666', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate, 1761000000000000103, 1761100000000000001, sysdate, NULL, null, sysdate, '');
...
-- ----------------------------
-- 一级菜单
insert into sys_menu values(1761400000000000001, '系统管理', 0, 1, 'system', null, '', 'N', 'Y', 'M', '0', '0', '', 'ri:settings-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '系统管理目录');
insert into sys_menu values(1761400000000000002, '系统监控', 0, 3, 'monitor', null, '', 'N', 'Y', 'M', '0', '0', '', 'ri:monitor-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '系统监控目录');
insert into sys_menu values(1761400000000000003, '系统工具', 0, 4, 'tool', null, '', 'N', 'Y', 'M', '0', '0', '', 'ri:tool-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '系统工具目录');
insert into sys_menu values(1761400000000000005, '测试菜单', 0, 5, 'demo', null, '', 'N', 'Y', 'M', '0', '0', null, 'ri:star-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '');
insert into sys_menu values(1761400000000000006, 'AI会话', 0, 8, 'aichat', 'ai/chat/index', '', 'N', 'Y', 'C', '0', '0', '', 'ri:checkbox-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'AI聊天菜单');
insert into sys_menu values(1761400000000000004, 'PLUS官网', 0, 9, 'https://gitee.com/dromara/RuoYi-Vue-Plus', null, '', 'Y', 'Y', 'M', '0', '0', '', 'ri:compass-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'RuoYi-Vue-Plus官网地址');
-- 二级菜单
insert into sys_menu values(1761400000000000100, '用户管理', 1761400000000000001, 1, 'user', 'system/user/index', '', 'N', 'Y', 'C', '0', '0', 'system:user:list', 'ri:user-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '用户管理菜单');
insert into sys_menu values(1761400000000000101, '角色管理', 1761400000000000001, 2, 'role', 'system/role/index', '', 'N', 'Y', 'C', '0', '0', 'system:role:list', 'ri:users-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '角色管理菜单');
insert into sys_menu values(1761400000000000102, '菜单管理', 1761400000000000001, 3, 'menu', 'system/menu/index', '', 'N', 'Y', 'C', '0', '0', 'system:menu:list', 'ri:git-branch-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '菜单管理菜单');
insert into sys_menu values(1761400000000000103, '部门管理', 1761400000000000001, 4, 'dept', 'system/dept/index', '', 'N', 'Y', 'C', '0', '0', 'system:dept:list', 'ri:tree-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '部门管理菜单');
insert into sys_menu values(1761400000000000104, '岗位管理', 1761400000000000001, 5, 'post', 'system/post/index', '', 'N', 'Y', 'C', '0', '0', 'system:post:list', 'ri:mail-open-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '岗位管理菜单');
insert into sys_menu values(1761400000000000105, '字典管理', 1761400000000000001, 6, 'dict', 'system/dict/index', '', 'N', 'Y', 'C', '0', '0', 'system:dict:list', 'ri:book-open-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '字典管理菜单');
insert into sys_menu values(1761400000000000106, '参数设置', 1761400000000000001, 7, 'config', 'system/config/index', '', 'N', 'Y', 'C', '0', '0', 'system:config:list', 'ri:pencil-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '参数设置菜单');
insert into sys_menu values(1761400000000000107, '通知公告', 1761400000000000001, 8, 'notice', 'system/notice/index', '', 'N', 'Y', 'C', '0', '0', 'system:notice:list', 'ri:message-circle-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '通知公告菜单');
insert into sys_menu values(1761400000000000108, '日志管理', 1761400000000000001, 9, 'log', '', '', 'N', 'Y', 'M', '0', '0', '', 'ri:file-text-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '日志管理菜单');
insert into sys_menu values(1761400000000000109, '在线用户', 1761400000000000002, 1, 'online', 'monitor/online/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:online:list', 'ri:users-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '在线用户菜单');
insert into sys_menu values(1761400000000000113, '缓存监控', 1761400000000000002, 5, 'cache', 'monitor/cache/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:cache:list', 'ri:database-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '缓存监控菜单');
insert into sys_menu values(1761400000000000115, '代码生成', 1761400000000000003, 2, 'gen', 'tool/gen/index', '', 'N', 'Y', 'C', '0', '0', 'tool:gen:list', 'ri:code-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '代码生成菜单');
insert into sys_menu values(1761400000000000123, '客户端管理', 1761400000000000001, 11, 'client', 'system/client/index', '', 'N', 'Y', 'C', '0', '0', 'system:client:list', 'ri:globe-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '客户端管理菜单');
...
-- springboot-admin监控
insert into sys_menu values(1761400000000000117, 'Admin监控', 1761400000000000002, 5, 'Admin', 'monitor/admin/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:admin:list', 'ri:dashboard-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'Admin监控菜单');
-- oss菜单
insert into sys_menu values(1761400000000000118, '文件管理', 1761400000000000001, 10, 'oss', 'system/oss/index', '', 'N', 'Y', 'C', '0', '0', 'system:oss:list', 'ri:upload-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '文件管理菜单');
-- snail-job server控制台
insert into sys_menu values(1761400000000000120, '任务调度中心', 1761400000000000002, 5, 'snailjob', 'monitor/snailjob/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:snailjob:list', 'ri:briefcase-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'snailjob控制台菜单');
-- snail-ai server控制台
insert into sys_menu values(1761400000000000121, 'AI控制台', 1761400000000000002, 7, 'snailai', 'monitor/snailai/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:snailai:list', 'ri:checkbox-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, 'AI控制台菜单');

-- 三级菜单
insert into sys_menu values(1761400000000000500, '操作日志', 1761400000000000108, 1, 'operlog', 'monitor/operlog/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:operlog:list', 'ri:file-edit-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '操作日志菜单');
insert into sys_menu values(1761400000000000501, '登录日志', 1761400000000000108, 2, 'logininfo', 'monitor/logininfo/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:logininfo:list', 'ri:login-circle-line', '', '', 1761000000000000103, 1761100000000000001, sysdate, null, null, '登录日志菜单');
-- 用户管理按钮
