...
create table sys_user_password_history (
    ...
    key idx_sys_user_password_history_user_id (user_id)
) engine=innodb comment = '用户密码历史记录表';
...
insert into sys_user values(1761100000000000003, 1761000000000000108, 'test', '本部门及以下 密码666666', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate(), '','','',1761000000000000103, 1761100000000000001, sysdate(), 1761100000000000003, sysdate(), null, sysdate());
insert into sys_user values(1761100000000000004, 1761000000000000102, 'test1', '仅本人 密码666666', 'sys_user', '', '', '0', null, '$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', '0', '0', '127.0.0.1', sysdate(), '','','',1761000000000000103, 1761100000000000001, sysdate(), 1761100000000000004, sysdate(), null, sysdate());
...
insert into sys_menu values(1761400000000000002, '系统监控', 0, 3, 'monitor', null, '', 'N', 'Y', 'M', '0', '0', '', 'ri:pie-chart-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '系统监控目录');
insert into sys_menu values(1761400000000000003, '系统工具', 0, 4, 'tool', null, '', 'N', 'Y', 'M', '0', '0', '', 'ri:settings-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '系统工具目录');
insert into sys_menu values(1761400000000000005, '测试菜单', 0, 5, 'demo', null, '', 'N', 'Y', 'M', '0', '0', '', 'ri:star-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '测试菜单');
insert into sys_menu values(1761400000000000008, 'AI会话', 0, 8, 'aichat', 'ai/chat/index', '', 'N', 'Y', 'C', '0', '0', '', 'ri:checkbox-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, 'AI聊天菜单');
...
insert into sys_menu values(1761400000000000101, '角色管理', 1761400000000000001, 2, 'role', 'system/role/index', '', 'N', 'Y', 'C', '0', '0', 'system:role:list', 'ri:user-3-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '角色管理菜单');
...
insert into sys_menu values(1761400000000000107, '通知公告', 1761400000000000001, 8, 'notice', 'system/notice/index', '', 'N', 'Y', 'C', '0', '0', 'system:notice:list', 'ri:message-3-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '通知公告菜单');
...
insert into sys_menu values(1761400000000000109, '在线用户', 1761400000000000002, 1, 'online', 'monitor/online/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:online:list', 'ri:user-3-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '在线用户菜单');
...
-- snail-job server控制台
insert into sys_menu values(1761400000000000120, '任务调度中心', 1761400000000000002, 6, 'snailjob', 'monitor/snailjob/index', '', 'N', 'Y', 'C', '0', '0', 'monitor:snailjob:list', 'ri:briefcase-line', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, 'SnailJob控制台菜单');
-- snail-ai server控制台
...
create table sys_message (
                             ...
                             read_status char(1) default '0' comment '是否已读 0未读 1已读',
                             create_dept       bigint(20)      default null               comment '创建部门',
                             create_by         bigint(20)      default null               comment '创建者',
                             create_time       datetime                                   comment '创建时间',
                             update_by         bigint(20)      default null               comment '更新者',
