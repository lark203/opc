...
(
    ...
    update_time datetime2(7)                       NULL,
    remark      nvarchar(500)                      NULL,
    password_update_time datetime2(7)              NULL,
...
(
    ...
    password nvarchar(100) DEFAULT '' NULL,
    create_time datetime2(7) NULL,
    CONSTRAINT PK__sys_user__password_history PRIMARY KEY CLUSTERED (history_id)
        WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
        ON [PRIMARY]
)
ON [PRIMARY]
GO
CREATE NONCLUSTERED INDEX idx_sys_user_password_history_user_id ON sys_user_password_history (user_id)
GO

EXEC sys.sp_addextendedproperty
    'MS_Description', N'历史ID' ,
    'SCHEMA', N'dbo',
    'TABLE', N'sys_user_password_history',
    'COLUMN', N'history_id'
GO
EXEC sys.sp_addextendedproperty
    'MS_Description', N'用户ID' ,
...
GO
EXEC sys.sp_addextendedproperty
    'MS_Description', N'用户密码历史记录表' ,
    'SCHEMA', N'dbo',
    'TABLE', N'sys_user_password_history'
GO

INSERT sys_user VALUES (1761100000000000001, 1761000000000000103, N'admin', N'疯狂的狮子Li', N'sys_user', N'crazyLionLi@163.com', N'15888888888', N'1', NULL, N'$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', N'0', N'0', N'127.0.0.1', getdate(), 1761000000000000103, 1761100000000000001, getdate(), NULL, NULL, N'管理员', getdate())
GO
INSERT sys_user VALUES (1761100000000000003, 1761000000000000108, N'test', N'本部门及以下 密码666666', N'sys_user', N'', N'', N'0', NULL, N'$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', N'0', N'0', N'127.0.0.1', getdate(), 1761000000000000103, 1761100000000000001, getdate(), 1761100000000000003, getdate(), NULL, getdate());
GO
INSERT sys_user VALUES (1761100000000000004, 1761000000000000102, N'test1', N'仅本人 密码666666', N'sys_user', N'', N'', N'0', NULL, N'$2a$10$b8yUzN0C71sbz.PhNOCgJe.Tu1yWC3RNrTyjSQ8p1W0.aaUXUJ.Ne', N'0', N'0', N'127.0.0.1', getdate(), 1761000000000000103, 1761100000000000001, getdate(), 1761100000000000004, getdate(), NULL, getdate());
GO
