...
values (2100000000000000101, '系统配置', 1761400000000000001, 11, 'sysconfig', 'system/config/system', '', 'N', 'Y',
        'C', '0', '0', 'system:config:list', 'ri:exchange-2-line', '', '', 1761000000000000103, 1761100000000000001,
        '2026-07-27 14:33:20', 1761100000000000001, '2026-07-28 19:02:34', '系统配置目录');
insert into sys_menu
values (2100000000000000110, '网站配置', 2100000000000000101, 1, 'site', 'system/config/site', '', 'N', 'N', 'C', '1',
        '0', 'system:option:list', 'ri:apps-line', '', '', 1761000000000000103, 1761100000000000001,
        '2026-07-27 14:33:20', 1761100000000000001, '2026-07-27 16:01:51', '网站配置');
insert into sys_menu
values (2100000000000000111, '安全配置', 2100000000000000101, 2, 'security', 'system/config/security', '', 'N', 'N',
        'C', '1', '0', 'system:option:list', 'ri:shield-user-line', '', '', 1761000000000000103, 1761100000000000001,
        '2026-07-27 14:33:20', 1761100000000000001, '2026-07-27 16:04:16', '安全配置');
insert into sys_menu
values (2100000000000000112, '登录配置', 2100000000000000101, 3, 'login', 'system/config/login', '', 'N', 'N', 'C', '1',
        '0', 'system:option:list', 'ri:lock-2-line', '', '', 1761000000000000103, 1761100000000000001,
        '2026-07-27 14:33:20', 1761100000000000001, '2026-07-27 16:07:21', '登录配置');
insert into sys_menu
values (2100000000000000113, '邮件配置', 2100000000000000101, 4, 'mail', 'system/config/mail', '', 'N', 'N', 'C', '1',
        '0', 'system:option:list', 'ri:mail-line', '', '', 1761000000000000103, 1761100000000000001,
        '2026-07-27 14:33:20', 1761100000000000001, '2026-07-27 16:08:07', '邮件配置');
insert into sys_menu
values (2100000000000000114, '短信配置', 2100000000000000101, 5, 'sms', 'system/config/sms', '', 'N', 'N', 'C', '1',
        '0', 'system:sms:list', 'ri:chat-smile-ai-3-line', '', '', 1761000000000000103, 1761100000000000001,
        '2026-07-27 14:33:21', 1761100000000000001, '2026-07-27 16:08:43', '短信配置');
insert into sys_menu
values (2100000000000000115, '存储配置', 2100000000000000101, 6, 'oss', 'system/config/oss', '', 'N', 'N', 'C', '1',
        '0', 'system:ossConfig:list', 'ri:cloud-line', '', '', 1761000000000000103, 1761100000000000001,
        sysdate(), null, null, '存储配置');

-- 授权管理（置于系统配置下）
insert into sys_menu
values (2100000000000000116, '授权', 2100000000000000101, 7, 'license', 'system/config/license', '', 'N', 'N', 'C', '1',
        '0', 'system:license:list', 'ri:lock-password-line', '', '', 1761000000000000103, 1761100000000000001,
        sysdate(), null, null, '授权管理菜单');
insert into sys_menu
values (2100000000000000117, '授权查询', 2100000000000000116, 1, '#', '', '', 'N', 'Y', 'F', '0', '0',
        'system:license:query', '#', '', '', 1761000000000000103, 1761100000000000001, sysdate(), null, null, '');
...
(
    ...
    type              varchar(20) not null default 'single' comment '会话类型（single单聊）',
    ...
    status            char(1)              default '1' comment '状态（1正常 2删除）',
    create_dept       bigint(20)           default null comment '创建部门',
    create_by         bigint(20)           default null comment '创建者',
    create_time       datetime comment '创建时间',
    update_by         bigint(20)           default null comment '更新者',
...
-- 20、聊天会话成员表
-- ----------------------------
create table sys_chat_member
(
    id              bigint(20) not null comment '主键ID',
    conversation_id bigint(20) not null comment '会话ID',
    user_id         bigint(20) not null comment '用户ID',
    unread_count    int(4)     default 0 comment '未读消息数',
...
(
    ...
    status          char(1)              default '1' comment '状态（1已送达 2已读 3撤回）',
    create_dept     bigint(20)           default null comment '创建部门',
    create_by       bigint(20)           default null comment '创建者',
    create_time     datetime comment '创建时间',
    update_by       bigint(20)           default null comment '更新者',
    ...
    key idx_conv_create (conversation_id, create_time)
