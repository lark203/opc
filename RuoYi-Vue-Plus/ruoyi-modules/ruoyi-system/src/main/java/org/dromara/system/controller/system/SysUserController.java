...
public class SysUserController extends BaseController {
    ...
    public R<Void> add(@Validated @RequestBody SysUserBo user) {
        ...
        if (StringUtils.isNotEmpty(user.getPassword())) {
            passwordPolicyService.validatePassword(user.getPassword(), user.getUserName(), null);
        }
    ...
    public R<Void> resetPwd(@RequestBody SysUserBo user) {
        ...
        userService.checkUserDataScope(user.getUserId());
        // 校验密码策略
        SysUserVo existingUser = userService.selectUserById(user.getUserId());
        passwordPolicyService.validatePassword(user.getPassword(), existingUser.getUserName(), existingUser.getPassword());
        // 校验密码历史不可重复
        passwordPolicyService.checkPasswordHistory(user.getUserId(), user.getPassword());
        user.setPassword(BCrypt.hashpw(user.getPassword()));
