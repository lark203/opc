...
public class MailSendController {
    ...
    public R<Void> sendSimpleMessage(String to, String subject, String text) {
        MailBuilder.of(mailAccountResolver.resolve()).to(to).subject(subject).text(text).send();
        return R.ok();
    }
    ...
    public R<Void> sendMessageWithAttachment(String to, String subject, String text) {
        ...
        MailBuilder.of(mailAccountResolver.resolve()).to(to).subject(subject).text(text).files(new File("/xxx/xxx")).send();
        return R.ok();
    }
    ...
    public R<Void> sendMessageWithAttachments(String to, String subject, String text) {
        ...
        MailBuilder.of(mailAccountResolver.resolve()).to(to).subject(subject).text(text).files(array).send();
        return R.ok();
    }
